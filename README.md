...
**Also experienced with:** OOP application development, SQL database design, Power BI analytics, network design, AWS cloud architecture, and Agile project work
...
**Altrium CRM — Business Analyst & Scrum Master (project contributions)**

As a Business Analyst, I worked on requirements analysis and refinement, product and sprint backlogs, user stories, UML diagrams, role and permission analysis, business process documentation, and keeping project documentation aligned with the implemented system.

I also served as **Scrum Master for part of the project**, where I managed meeting minutes and updated the Scrum board by adding sprint features, user stories, descriptions, and related work items.

**Group Repository:** [Altrium CRM](https://github.com/Thehan-Andaramana/Altrium-CRM)

**My BA Work:** [BA Branch](https://github.com/Thehan-Andaramana/Altrium-CRM/tree/BA)
